  ...
  return (
    <main className="min-h-screen bg-gray-950 text-white">
      <nav className="flex items-center justify-between px-6 py-4 border-b border-white/10">
        <Link href="/" className="text-xl font-bold">Aurora Rayes Pet Care Agent</Link>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-2xl mx-auto">
          ...
          <div className="bg-violet-600/10 border border-violet-500 rounded-2xl p-8 text-left relative">
            ...
            <ul className="space-y-3 mb-8">
              ...
              <li className="flex items-center gap-2 text-gray-300"><span className="text-green-400">check</span> Symptom checker</li>
              <li className="flex items-center gap-2 text-gray-300"><span className="text-green-400">check</span> Vet Q&A</li>
              <li className="flex items-center gap-2 text-gray-300"><span className="text-green-400">check</span> Vaccination tracker</li>
              <li className="flex items-center gap-2 text-gray-300"><span className="text-green-400">check</span> Diet planner</li>
              <li className="flex items-center gap-2 text-gray-300"><span className="text-green-400">check</span> Breed insights</li>
