  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950">
      <nav className="flex items-center justify-between px-6 py-4 border-b border-white/10">
        <div className="text-xl font-bold text-white">Aurora Rayes Pet Care Agent</div>
      ...
      <section className="max-w-4xl mx-auto px-6 py-24 text-center">
        ...
        <p className="text-xl text-gray-400 mb-10 max-w-2xl mx-auto">
          Aurora Rayes Pet Care Agent uses advanced AI to give you personalized, actionable insights. Start free, upgrade when ready.
        </p>
      ...
      <section className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-white/5 border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-colors">
            ...
            <h3 className="text-white font-semibold mb-2">Symptom checker</h3>
            <p className="text-gray-400 text-sm">Powered by advanced AI for maximum results.</p>
          </div>
          <div className="bg-white/5 border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-colors">
            <div className="text-violet-400 text-2xl mb-3">AI</div>
            <h3 className="text-white font-semibold mb-2">Vet Q&A</h3>
            <p className="text-gray-400 text-sm">Powered by advanced AI for maximum results.</p>
          </div>
          <div className="bg-white/5 border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-colors">
            <div className="text-violet-400 text-2xl mb-3">AI</div>
            <h3 className="text-white font-semibold mb-2">Vaccination tracker</h3>
            <p className="text-gray-400 text-sm">Powered by advanced AI for maximum results.</p>
          </div>
          <div className="bg-white/5 border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-colors">
            <div className="text-violet-400 text-2xl mb-3">AI</div>
            <h3 className="text-white font-semibold mb-2">Diet planner</h3>
            <p className="text-gray-400 text-sm">Powered by advanced AI for maximum results.</p>
          </div>
          <div className="bg-white/5 border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-colors">
            <div className="text-violet-400 text-2xl mb-3">AI</div>
            <h3 className="text-white font-semibold mb-2">Breed insights</h3>
            <p className="text-gray-400 text-sm">Powered by advanced AI for maximum results.</p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-2xl mx-auto px-6 py-16 text-center">
        <div className="bg-violet-600/10 border border-violet-500/20 rounded-2xl p-10">
          ...
          <p className="text-gray-400 mb-8">Join thousands of users already using Aurora Rayes Pet Care Agent.</p>
      ...
      <footer className="border-t border-white/10 px-6 py-8 text-center text-gray-500 text-sm">
        &copy; 2026 Aurora Rayes Pet Care Agent. All rights reserved.
      </footer>
    </main>
  )
}
